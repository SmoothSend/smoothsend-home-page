    ...
    <section className="min-h-screen flex flex-col justify-center py-20 md:py-32" aria-labelledby="hero-heading">
      <div className="container mx-auto px-4 text-center">
        <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm mb-8" role="banner">
          ...
          <span>ERC-4337 account abstraction on Avalanche, Base &amp; Arbitrum — plus Aptos sponsored transactions</span>
        ...
        <h1 id="hero-heading" className="text-4xl md:text-6xl lg:text-7xl font-bold text-balance mb-6">
          ...
          <br />
          <span className="text-primary">on Aptos, Arbitrum, Base &amp; Avalanche</span>
        </h1>

        <p className="text-xl md:text-2xl text-muted-foreground text-balance mb-12 max-w-3xl mx-auto leading-relaxed">
          The first true gasless payment protocol. Send stablecoins using{" "}
          <strong>ERC-4337 account abstraction</strong> — users pay fees in the token they&apos;re
          already sending. No ETH, no APT, no friction.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Try EVM Demo - Avalanche, Base & Arbitrum (opens in new tab)"
            >
              Try EVM Demo
              <ArrowRight className="ml-2 w-5 h-5" aria-hidden="true" />
            </a>
