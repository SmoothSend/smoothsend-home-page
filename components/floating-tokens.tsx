...
export function FloatingTokens() {
  ...
  return (
    <div 
      ...
      role="img" 
      aria-label="Decorative floating cryptocurrency tokens including USDC, Aptos, Avalanche, PayPal USD, Base, Arbitrum, and SmoothSend logos"
    >
      {cryptoTokens.map((token) => (
        <div
          ...
          style={{
            ...
            borderRadius: token.symbol === 'APT' ? '50%' : '50%',
